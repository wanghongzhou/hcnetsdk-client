...
public interface HCNetSDK extends Library {
    ...
    int DEL_SEQ = 43; //删除巡航路径
    int STOP_CRUISE = 44; /* 停止运行轨迹*/
    int DELETE_CRUISE = 45;/* 删除单条轨迹 */
    int DELETE_ALL_CRUISE = 46; /*删除所有轨迹*/
    int NET_DVR_CONTROL_PTZ_PATTERN = 3313;/*快球云台花样扫描*/
    ...
    int NET_DVR_GET_DEVICECFG_V40 = 1100;        //获取设备参数(扩展)
    int NET_DVR_GET_AUDIO_INPUT = 3201;        //获取音频输入参数
    int NET_DVR_SET_AUDIO_INPUT = 3202;        //设置音频输入参数
    //对应NET_DVR_EMAILPARA
    ...
    //设备的配置信息配置
    int NET_DVR_GET_ISP_CAMERAPARAMCFG = 3255;    //获取设备的配置信息
    int NET_DVR_SET_ISP_CAMERAPARAMCFG = 3256;    //设置设备的配置信息
    /***************************DS9000新增命令(_V30) end *****************************/
    /*************************参数配置命令 end*******************************/
    /*******************查找文件和日志函数返回值*************************/
    ...
    int COMM_UPLOAD_PLATE_RESULT = 0x2800;//交通抓拍结果(车辆、车牌识别及抓拍图片)上传
    int COMM_ID_INFO_ALARM = 0x5200;//人脸身份证比对类型
    ...
    /*********************回调函数类型 end************************/
    //设备型号(DVR类型)
    /* 设备类型 */ int DVR = 1;            /*对尚未定义的dvr类型返回NETRET_DVR*/
    ...
    int MINOR_NET_DISK_INFO = 0xa8;
    int MINOR_RAID_INFO = 0xa9;
    int MINOR_RUN_STATUS_INFO = 0xaa;
    ...
    // 主类型
    int MAJOR_EXCEPTION = 0x2;
    // 次类型
    int MINOR_RAID_ERROR = 0x20; /* 阵列异常 */
    int MINOR_VI_LOST = 0x21;/* 视频信号丢失 */
    int MINOR_ILLEGAL_ACCESS = 0x22;/* 非法访问 */
    int MINOR_HD_FULL = 0x23;/* 硬盘满 */
    int MINOR_HD_ERROR = 0x24;/* 硬盘错误 */
    int MINOR_DCD_LOST = 0x25;/* MODEM 掉线(保留不使用) */
    int MINOR_IP_CONFLICT = 0x26; /* IP地址冲突 */
    int MINOR_NET_BROKEN = 0x27; /* 网络断开 */
    int MINOR_REC_ERROR = 0x28; /* 录像出错 */
    int MINOR_IPC_NO_LINK = 0x29; /* IPC连接异常 */
    int MINOR_VI_EXCEPTION = 0x2a; /* 视频输入异常(只针对模拟通道) */
    int MINOR_IPC_IP_CONFLICT = 0x2b; /* ipc ip 地址 冲突 */
    int MINOR_SENCE_EXCEPTION = 0x2c; // 场景异常

    //主类型
    int MAJOR_ALARM = 0x1;
    // 次类型
    int MINOR_ALARM_IN = 0x1; /* 报警输入 */
    int MINOR_ALARM_OUT = 0x2; /* 报警输出 */
    int MINOR_MOTDET_START = 0x3; /* 移动侦测报警开始 */
    int MINOR_MOTDET_STOP = 0x4; /* 移动侦测报警结束 */
    int MINOR_HIDE_ALARM_START = 0x5; /* 遮挡报警开始 */
    int MINOR_HIDE_ALARM_STOP = 0x6; /* 遮挡报警结束 */
    int MINOR_VCA_ALARM_START = 0x7; /* 智能报警开始 */
    int MINOR_VCA_ALARM_STOP = 0x8; /* 智能报警停止 */
    int MINOR_ITS_ALARM_START = 0x09; // 交通事件报警开始
    int MINOR_ITS_ALARM_STOP = 0x0A; // 交通事件报警结束
    // 2010-11-10 网络报警日志
    int MINOR_NETALARM_START = 0x0b; /* 网络报警开始 */
    int MINOR_NETALARM_STOP = 0x0c; /* 网络报警结束 */
    // 2010-12-16 报警板日志，与"MINOR_ALARM_IN"配对使用
    int MINOR_NETALARM_RESUME = 0x0d; /* 网络报警恢复 */
    // 2012-4-5 IPC PIR、无线、呼救报警
    int MINOR_WIRELESS_ALARM_START = 0x0e; /* 无线报警开始 */
    int MINOR_WIRELESS_ALARM_STOP = 0x0f; /* 无线报警结束 */
    int MINOR_PIR_ALARM_START = 0x10; /* 人体感应报警开始 */
    int MINOR_PIR_ALARM_STOP = 0x11; /* 人体感应报警结束 */
    int MINOR_CALLHELP_ALARM_START = 0x12; /* 呼救报警开始 */
    int MINOR_CALLHELP_ALARM_STOP = 0x13; /* 呼救报警结束 */
    int MINOR_IPCHANNEL_ALARMIN_START = 0x14; // 数字通道报警输入开始：PCNVR在接收到数字通道的MINOR_ALARM_IN产生“数字通道报警输入开始”，10s，再收不到MINOR_ALARM_IN，产生“数字通道报警输入结束”
    int MINOR_IPCHANNEL_ALARMIN_STOP = 0x15; // 数字通道报警输入开始：同上
    int MINOR_DETECTFACE_ALARM_START = 0x16; /* 人脸侦测报警开始 */
    int MINOR_DETECTFACE_ALARM_STOP = 0x17; /* 人脸侦测报警结束 */
    int MINOR_VQD_ALARM_START = 0x18; // VQD报警
    int MINOR_VQD_ALARM_STOP = 0x19; // VQD报警结束
    int MINOR_VCA_SECNECHANGE_DETECTION = 0x1a; // 场景侦测报警
    // 2013-07-16

    int MINOR_SMART_REGION_EXITING_BEGIN = 0x1b; // 离开区域侦测开始
    int MINOR_SMART_REGION_EXITING_END = 0x1c; // 离开区域侦测结束
    int MINOR_SMART_LOITERING_BEGIN = 0x1d; // 徘徊侦测开始
    int MINOR_SMART_LOITERING_END = 0x1e; // 徘徊侦测结束

    int MINOR_VCA_ALARM_LINE_DETECTION_BEGIN = 0x20;
    int MINOR_VCA_ALARM_LINE_DETECTION_END = 0x21;
    int MINOR_VCA_ALARM_INTRUDE_BEGIN = 0x22; // 区域侦测开始
    int MINOR_VCA_ALARM_INTRUDE_END = 0x23; // 区域侦测结束
    int MINOR_VCA_ALARM_AUDIOINPUT = 0x24; // 音频异常输入
    int MINOR_VCA_ALARM_AUDIOABNORMAL = 0x25; // 声强突变
    int MINOR_VCA_DEFOCUS_DETECTION_BEGIN = 0x26; // 虚焦侦测开始
    int MINOR_VCA_DEFOCUS_DETECTION_END = 0x27; // 虚焦侦测结束

    // 民用NVR
    int MINOR_EXT_ALARM = 0x28;/* IPC外部报警 */
    int MINOR_VCA_FACE_ALARM_BEGIN = 0x29; /* 人脸侦测开始 */
    int MINOR_SMART_REGION_ENTRANCE_BEGIN = 0x2a; // 进入区域侦测开始
    int MINOR_SMART_REGION_ENTRANCE_END = 0x2b; // 进入区域侦测结束
    int MINOR_SMART_PEOPLE_GATHERING_BEGIN = 0x2c; // 人员聚集侦测开始
    int MINOR_SMART_PEOPLE_GATHERING_END = 0x2d; // 人员聚集侦测结束
    int MINOR_SMART_FAST_MOVING_BEGIN = 0x2e; // 快速运动侦测开始
    int MINOR_SMART_FAST_MOVING_END = 0x2f; // 快速运动侦测结束

    int MINOR_VCA_FACE_ALARM_END = 0x30; /* 人脸侦测结束 */
    int MINOR_VCA_SCENE_CHANGE_ALARM_BEGIN = 0x31; /* 场景变更侦测开始 */
    int MINOR_VCA_SCENE_CHANGE_ALARM_END = 0x32; /* 场景变更侦测结束 */
    int MINOR_VCA_ALARM_AUDIOINPUT_BEGIN = 0x33; /* 音频异常输入开始 */
    int MINOR_VCA_ALARM_AUDIOINPUT_END = 0x34; /* 音频异常输入结束 */
    int MINOR_VCA_ALARM_AUDIOABNORMAL_BEGIN = 0x35; /* 声强突变侦测开始 */
    int MINOR_VCA_ALARM_AUDIOABNORMAL_END = 0x36; /* 声强突变侦测结束 */

    int MINOR_VCA_LECTURE_DETECTION_BEGIN = 0x37; // 授课侦测开始报警
    int MINOR_VCA_LECTURE_DETECTION_END = 0x38; // 授课侦测结束报警
    int MINOR_VCA_ALARM_AUDIOSTEEPDROP = 0x39; // 声强陡降
    // 2014-03-21
    int MINOR_VCA_ANSWER_DETECTION_BEGIN = 0x3a; // 回答问题侦测开始报警
    int MINOR_VCA_ANSWER_DETECTION_END = 0x3b; // 回答问题侦测结束报警

    int MINOR_SMART_PARKING_BEGIN = 0x3c; // 停车侦测开始
    int MINOR_SMART_PARKING_END = 0x3d; // 停车侦测结束
    int MINOR_SMART_UNATTENDED_BAGGAGE_BEGIN = 0x3e; // 物品遗留侦测开始
    int MINOR_SMART_UNATTENDED_BAGGAGE_END = 0x3f; // 物品遗留侦测结束
    int MINOR_SMART_OBJECT_REMOVAL_BEGIN = 0x40; // 物品拿取侦测开始
    int MINOR_SMART_OBJECT_REMOVAL_END = 0x41; // 物品拿取侦测结束
    int MINOR_SMART_VEHICLE_ALARM_START = 0x46; // 车牌检测开始
    int MINOR_SMART_VEHICLE_ALARM_STOP = 0x47; // 车牌检测结束
    int MINOR_THERMAL_FIREDETECTION = 0x48; // 热成像火点检测侦测开始
    int MINOR_THERMAL_FIREDETECTION_END = 0x49; // 热成像火点检测侦测结束
    int MINOR_SMART_VANDALPROOF_BEGIN = 0x50; // 防破坏检测开始
    int MINOR_SMART_VANDALPROOF_END = 0x51; // 防破坏检测结束

    // 0x400-0x1000 门禁报警
    int MINOR_ALARMIN_SHORT_CIRCUIT = 0x400; // 防区短路报警
    int MINOR_ALARMIN_BROKEN_CIRCUIT = 0x401; // 防区断路报警
    int MINOR_ALARMIN_EXCEPTION = 0x402; // 防区异常报警
    int MINOR_ALARMIN_RESUME = 0x403; // 防区报警恢复
    int MINOR_HOST_DESMANTLE_ALARM = 0x404; // 防区防拆报警
    int MINOR_HOST_DESMANTLE_RESUME = 0x405; // 防区防拆恢复
    int MINOR_CARD_READER_DESMANTLE_ALARM = 0x406; // 读卡器防拆报警
    int MINOR_CARD_READER_DESMANTLE_RESUME = 0x407; // 读卡器防拆恢复
    int MINOR_CASE_SENSOR_ALARM = 0x408; // 事件输入报警
    int MINOR_CASE_SENSOR_RESUME = 0x409; // 事件输入恢复
    int MINOR_STRESS_ALARM = 0x40a; // 胁迫报警
    int MINOR_OFFLINE_ECENT_NEARLY_FULL = 0x40b;// 离线事件满90%报警
    int MINOR_CARD_MAX_AUTHENTICATE_FAIL = 0x40c; // 卡号认证失败超次报警
    int MINOR_SD_CARD_FULL = 0x40d; // SD卡存储满报警
    int MINOR_LINKAGE_CAPTURE_PIC = 0x40e; // 联动抓拍事件报警
    //SDK_V222
    //智能设备类型
    ...
    int MAX_DEVICES = 512;//max device number
    ...
    class NET_DVR_TIME_V29 extends HCNetSDKStructure {
    ...
    class NET_DVR_COMPRESSIONCFG_EX extends HCNetSDKStructure {//通道压缩参数(扩展)
        public int dwSize;
    ...
    class NET_DVR_RECCOMPRESSIONCFG_EX extends HCNetSDKStructure {//录象时间段压缩参数配置(GE定制)2006-09-18
        int dwSize;
    ...
    class Bind extends HCNetSDKStructure {
    ...
    // https://jna.dev.java.net/javadoc/com/sun/jna/Union.html#setType see how to use the JNA Union
    class NET_DVR_PLAYREMOTEFILE extends HCNetSDKStructure {/* 控制网络文件回放 */
        ...
        public static class mode_size extends Union {
            ...
            public static class bytime extends HCNetSDKStructure {
    ...
    class NET_DVR_DECCHANSTATUS extends HCNetSDKStructure {/*当前设备解码连接状态*/
        ...
        public static class objectInfo extends Union {
            ...
            public static class userInfo extends HCNetSDKStructure {
            ...
            public static class fileInfo extends HCNetSDKStructure {

                public byte[] fileName = new byte[100];
            }

            public static class timeInfo extends HCNetSDKStructure {
    ...
    */
    ...
    class STRU_CHANNEL_INFO extends HCNetSDKStructure {
    ...
    class NET_DVR_IPPARACFG_V40 extends HCNetSDKStructure {
    ...
    class NET_DVR_IPALARMININFO_V40 extends HCNetSDKStructure {
    ...
    class NET_DVR_IPALARMINCFG_V40 extends HCNetSDKStructure {
    ...
    class NET_DVR_IPALARMOUTINFO_V40 extends HCNetSDKStructure {
    ...
    class NET_DVR_IPALARMOUTCFG_V40 extends HCNetSDKStructure {
    ...
    class PASSIVEDECODE_CHANINFO extends HCNetSDKStructure {
    ...
    class NET_DVR_VOD_PARA extends HCNetSDKStructure {
    ...
    class NET_DVR_SPECIAL_FINDINFO_UNION extends HCNetSDKStructure {

        public byte[] byLength = new byte[8];
        public NET_DVR_ATMEINDINFO struATMFindInfo = new NET_DVR_ATMEINDINFO();
    }

    class NET_DVR_ATMEINDINFO extends HCNetSDKStructure {
    ...
    class NET_DVR_PLAYCOND extends HCNetSDKStructure {
    ...
    //云台花样扫描参数结构
    class NET_DVR_PTZ_PATTERN extends HCNetSDKStructure {
    ...
    class NET_DVR_FUZZY_UPGRADE extends HCNetSDKStructure {
    ...
    class NET_DVR_AUXILIARY_DEV_UPGRADE_PARAM extends HCNetSDKStructure {
    ...
    //客流量统计参数
    class struStatFrame extends HCNetSDKStructure {
    ...
    class struStartTime extends HCNetSDKStructure {
    ...
    class NET_DVR_PDC_ALRAM_INFO extends HCNetSDKStructure {
    ...
    class B extends HCNetSDKStructure {
    ...
    class NET_DVR_AUDIO_INPUT_PARAM extends HCNetSDKStructure {
    ...
    //ISP前端参数配置结构体
    class NET_DVR_ISP_CAMERAPARAMCFG extends HCNetSDKStructure {
    ...
    interface FExceptionCallBack extends Callback {
        ...
        void invoke(int dwType, NativeLong lUserID, NativeLong lHandle, Pointer pUser) throws InterruptedException;
    }

    interface FDrawFun extends Callback {

        void invoke(NativeLong lRealHandle, WinDef.HDC hDc, int dwUser);
    }
    ...
    boolean NET_DVR_GetConfigFile_V30(NativeLong lUserID, Pointer sOutBuffer, int dwOutSize, IntByReference pReturnSize);
    ...
    class NET_DVR_UPGRADE_PARAM extends HCNetSDKStructure {
...
interface GDI32 extends W32APIOptions {

    GDI32 INSTANCE = Native.load("gdi32", GDI32.class, DEFAULT_OPTIONS);

    int TRANSPARENT = 1;

    int SetBkMode(WinDef.HDC hdc, int i); // 设置背景混合模式

    WinNT.HANDLE CreateSolidBrush(int icolor); // 创建指定颜色的笔刷
}
...
interface USER32 extends W32APIOptions {
    ...
    int FillRect(WinDef.HDC hDC, RECT lprc, WinNT.HANDLE hbr);  // 填充矩形

    boolean DrawEdge(WinDef.HDC hdc, RECT qrc, int edge, int grfFlags); // 绘制矩形的一个或多个边缘
}
